...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(330, 490)
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.outputLabel = QtWidgets.QLabel(self.centralwidget)
        self.outputLabel.setGeometry(QtCore.QRect(10, 10, 301, 91))
        font = QtGui.QFont()
        ...
        self.percentButton.setGeometry(QtCore.QRect(10, 110, 61, 61))
        font = QtGui.QFont()
        font.setPointSize(26)
        self.percentButton.setFont(font)
        self.percentButton.setObjectName("percentButton")
        self.arrowButton = QtWidgets.QPushButton(self.centralwidget, clicked= lambda: self.press_it("<<"))
        self.arrowButton.setGeometry(QtCore.QRect(170, 110, 61, 61))
        font = QtGui.QFont()
        font.setPointSize(26)
        ...
        self.cButton.setGeometry(QtCore.QRect(90, 110, 61, 61))
        font = QtGui.QFont()
        font.setPointSize(26)
        self.cButton.setFont(font)
        self.cButton.setObjectName("cButton")
        self.divideButton = QtWidgets.QPushButton(self.centralwidget, clicked= lambda: self.press_it("/"))
        self.divideButton.setGeometry(QtCore.QRect(250, 110, 61, 61))
        font = QtGui.QFont()
        font.setPointSize(26)
        ...
        self.multiplyButton.setGeometry(QtCore.QRect(250, 180, 61, 61))
        font = QtGui.QFont()
        font.setPointSize(26)
        ...
        self.zeroButton.setGeometry(QtCore.QRect(90, 390, 61, 61))
        font = QtGui.QFont()
        font.setPointSize(26)
        self.zeroButton.setFont(font)
        self.zeroButton.setObjectName("zeroButton")
        self.plusminusButton = QtWidgets.QPushButton(self.centralwidget, clicked= lambda: self.press_it("+/-"))
        self.plusminusButton.setGeometry(QtCore.QRect(10, 390, 61, 61))
        font = QtGui.QFont()
        font.setPointSize(26)
